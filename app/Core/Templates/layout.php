...
<head>
    ...
    <link href="<?= htmlspecialchars($app['base_url'], ENT_QUOTES, 'UTF-8') ?>/assets/css/app.css" rel="stylesheet">
</head>
<body class="bg-light">
    ...
    <script src="<?= htmlspecialchars($app['base_url'], ENT_QUOTES, 'UTF-8') ?>/assets/js/app.js"></script>
</body>
</html>
